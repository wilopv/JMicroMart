...
7. **Local Infra**: Docker Compose for services and PostgreSQL instances.
8. **AI Assistance**: AI tools may assist with implementation but must follow `.ai/` guardrails and `docs/` decisions.
